...
// Function to compute Equal Shares Method with a fixed budget
vector<string> equal_shares_fixed_budget(const vector<string>& voters, const vector<string>& projects,
                                         const unordered_map<string, double>& cost,
...
// Main function to compute Equal Shares with adjustable budget
vector<string> equal_shares_add1(const vector<string>& voters, const vector<string>& projects,
                            const unordered_map<string, double>& cost,
                            unordered_map<string, vector<string>>& approvers,
                            double total_budget) {
    // Step 1: Start with a fixed budget method
    vector<string> mes = equal_shares_fixed_budget(voters, projects, cost, approvers, total_budget);
    ...
    while (true) {
        ...
        vector<string> next_mes = equal_shares_fixed_budget(voters, projects, cost, approvers, next_budget);
